...
# ============================================================================
# SLIDE 7: Novelty of This Work
# ============================================================================
add_content_slide(prs, "Novelty of This Work", [
    ("This project contributes a practical and structured QGCN workflow for power systems.", 0, False),
    ("", 0, False),
    ("Key Novel Elements:", 0, True),
    ("Phase-wise end-to-end implementation from grid graph creation to risk prediction", 1, False),
    ("Hybrid design: graph topology learning + quantum-inspired feature processing", 1, False),
    ("Focus on operational relevance: output is an actionable instability probability", 1, False),
    ("", 0, False),
    ("Why This Is Different:", 0, True),
    ("Not just a theoretical concept; includes executable modules for each stage", 1, False),
    ("Benchmarked against simple classical baselines to show practical benefit", 1, False),
    ("Designed as a reusable template for larger smart-grid reliability studies", 1, False),
])

# ============================================================================
# SLIDE 8: Results, Impact, and Easy Interpretation
# ============================================================================
add_content_slide(prs, "How It Helps: Results in Easy Terms", [
    ("Model Performance (IEEE 14-bus, 250 samples):", 0, True),
    ("Run src/demo.py to generate current CPU-mode metrics in docs/EXECUTION_SUMMARY.md", 1, False),
    ("Interpretation: use those values for current run-specific discussion", 1, False),
    ("", 0, False),
...
add_content_slide(prs, "Baseline Comparison (Why QGCN Is Useful)", [
    ...
    ("Use docs/EXECUTION_SUMMARY.md for run-specific QGCN metrics", 1, False),
...
print("  Slide 7: Novelty of This Work")
print("  Slide 8: Results, Impact, and Easy Interpretation")
print("  Slide 9: Baseline Comparison")
