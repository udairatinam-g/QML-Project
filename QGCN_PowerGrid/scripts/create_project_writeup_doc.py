...
def build_writeup() -> None:
    ...
    body_text = (
        ...
        "The developed system generates reproducible predictive metrics from the execution pipeline "
        "on the generated test scenarios. These results indicate that "
        "the model can identify risky grid states while maintaining a practical trade-off between "
